...
at=-wrap(im(m(1)+1,m(2))-im(m(1),m(2)))-wrap(im(m(1),m(2)+1)-im(m(1),m(2)))+wrap(im(m(1)+1,m(2)+1)-im(m(1),m(2)));
bt=wrap(im(m(1),m(2)+1)-im(m(1),m(2)));
ct=wrap(im(m(1)+1,m(2))-im(m(1),m(2)));
va=wrap(at*dm(1)*dm(2)+bt*dm(2)+ct*dm(1)+im(m(1),m(2)));
